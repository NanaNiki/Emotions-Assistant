...
export default function Thankyou() {
  ...
  return (
    <div className="h-screen w-screen flex flex-col" id="thankyou">
      <h1 className="animated-item show-up text-4xl text-center sm:mt-10 mt-5 shadow-text">
        Ok!
      </h1>
      <div className="flex flex-col sm:w-8/12 w-10/12 mx-auto sm:mt-5 mt-3">
        ...
        <div className="flex sm:flex-row flex-col sm:mt-10 mt-3">
          <h1 className="sm:w-8/12 sm:px-5 py-3 animated-item show-up delay-[4s] sm:text-xl text-justify font-bold mx-auto">
          ...
          <div className="flex flex-col sm:text-xl text-base font-bold text-indigo-400 animated-item show-up sm:delay-[8s] delay-[5s]">
            <Link
        ...
        <div
          className={`${caveat.className} animated-item show-up delay-[11s] sm:text-5xl text-4xl text-center mt-3`}
        >
          <h1>Keep feelin'!</h1>
          <h1>Keep livin'!</h1>
        </div>
        <div className="flex flex-row sm:mt-10 mt-5 justify-center sm:text-2xl text-pink-200">
          <button
            onClick={() => window.location.reload()}
            className="outline outline-2 outline-pink-600 rounded-full w-fit h-fit sm:px-3 sm:py-2 px-2 py-0.5 mx-2 shadow-md shadow-pink-600 transition-all duration-500 active:-hue-rotate-30 hover:text-pink-600 hover:shadow-lg hover:shadow-pink-950"
          >
            Start a new process
          </button>
          <button className="outline outline-2 outline-pink-600 rounded-full w-fit h-fit sm:px-3 sm:py-2 px-2 py-0.5 mx-2 shadow-md shadow-pink-600 transition-all duration-500 active:-hue-rotate-30 hover:text-pink-600 hover:shadow-lg hover:shadow-pink-950">
            Get my report
          </button>
        </div>
      </div>
